...
public class MapToJson {
    ...
    public static List<String> getSAOrderparamsJson(Map<String,Object> mm, ESaleRoot eSaleRoot){
        ...
        while (edatamap.keySet().iterator().hasNext()){
            ...
            List<ESaleData> esalelist = (List<ESaleData>)edatamap.get(patientId); // esalelist
            ...
            sa.put("Department",Department);
            Map<String,Object> Clerk = new HashMap<String,Object>();
            Clerk.put("Code","CD-030");//业务员编码 （咨询师）
            sa.put("Clerk",Clerk);
    ...
    //创建 生产加工单 的 请求参数 body 的 模板
    public static String getSCOrderparamsJson(Map<String,Object> mm){
        Map<String,Object> dto = new HashMap<String,Object>();
        Map<String,Object> sa = new HashMap<String,Object>();
        Map<String,Object> Department = new HashMap<String,Object>();
        Department.put("Code","HY");//部门编码
        ...
        Map<String,Object> DetailM1 = new HashMap<String,Object>();
        DetailM1.put("Code","1");//行号
        DetailM1.put("idsourceVoucherType","43");//来源单据类型ID
        DetailM1.put("SourceVoucherDetailId","1");//来源单据明细ID
    ...
    //创建 材料出库单 的 请求参数 body 的 模板
    public static String getCLCKOrderparamsJson(Map<String,Object> mm){
        Map<String,Object> dto = new HashMap<String,Object>();
        Map<String,Object> sa = new HashMap<String,Object>();
        Map<String,Object> Department = new HashMap<String,Object>();
        Department.put("Code","HY");//部门编码
    ...
    //创建销货单的 请求参数 body 的 模板
    public static String getSASOrderparamsJson(Map<String,Object> mm){
        Map<String,Object> dto = new HashMap<String,Object>();
        Map<String,Object> sa = new HashMap<String,Object>();
        Map<String,Object> Department = new HashMap<String,Object>();
        Department.put("Code","HY");//部门编码
        ...
        DetailM2.put("sourceVoucherCode","SO-2022-03-0004");//明细2 的 来源单据单据编号
        DetailM2.put("sourceVoucherDetailId","8");//明细2 的 来源单据单据对应的明细行ID
        SaleDeliveryDetails.add(DetailM2);
