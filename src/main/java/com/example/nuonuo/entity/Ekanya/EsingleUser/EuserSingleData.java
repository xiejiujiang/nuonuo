...
public class EuserSingleData {
    ...
    public void setFreeField(FreeField freeField){
        this.freeField = freeField;
    }
    public FreeField getFreeField(){
    ...
    public void setRecordUpdatedUser(int recordUpdatedUser){
        this.recordUpdatedUser = recordUpdatedUser;
    }
    public int getRecordUpdatedUser(){
        return this.recordUpdatedUser;
    }
